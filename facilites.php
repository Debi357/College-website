...
<div class="content-top">
			<div class="wrap">
                ...
                <p style="font-size:50px; color:blue; text-align:center;">Our Facilites</p>
</br>
</br>
</br>
 
                <h1 style="color:black;">Labs</h1>
                </br>
				<?php
    $sel="SELECT * FROM PAGES WHERE page_id='68'";
    $rs=$con->query($sel);
...
<p><?php echo $row['description']; ?></p>
     ...
     <?php } ?>
				...
				<?php
    $sel="SELECT * FROM PAGES WHERE page_id='69'";
    $rs=$con->query($sel);
    while($row=$rs->fetch_assoc()){ 
    ?>
